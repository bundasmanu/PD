...
public class OperadorController implements Serializable {
    ...
    private OperadorFacadeLocal getFacade() {
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(operadorFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(operadorFacade.findAll(), true);
    }
